...
서비스디자인 이론과 실무 지식을 바탕으로, 수험생의 사고력을 평가할 수 있는 '{random_seed_word}' 문제 50개를 생성해 주세요.
...
-   `"source"`: (String) 문제의 근거가 된 서비스디자인 이론이나 개념. 예: "더블 다이아몬드 모델", "사용자 여정 지도"
...
```
위 예시를 참고하여, 50개의 문제 객체를 포함하는 완전한 JSON 배열을 생성해 주세요.
"""
contents.append(user_prompt)
print("\n강화된 사용자 프롬프트가 준비되었습니다. (PDF 학습 없이 AI 성능으로만 생성)")

# --- Gemini API 호출 및 응답 생성 ---
print("\nGemini 모델 호출 중... (50개의 복잡한 문제를 생성하는 데 시간이 걸릴 수 있습니다)")
try:
    ...
    try:
        ...
        output_file_path = "../Nothing/gemini_questions.json"
